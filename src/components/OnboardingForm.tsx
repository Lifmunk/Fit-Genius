    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8 animate-fade-in">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl gradient-fire mb-4 shadow-glow">
            ...
            <div className="flex gap-3 mt-8">
              ...
              {step < 4 ? (
                <Button
                  ...
                  className="flex-1 gradient-fire border-0 hover:opacity-90"
                >
                  Continue
                </Button>
              ) : (
                <Button
                  ...
                  className="flex-1 gradient-fire border-0 hover:opacity-90 shadow-glow"
                >
                  Start My Journey
                </Button>
              )}
